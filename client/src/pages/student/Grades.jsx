...
export default function StudentGrades({ email, onOpenNotifications }) {
  ...
  const copy = isFrench
    ...
    : {
        title: 'My grades',
        subtitle: 'See your final grade and related alerts.',
        loading: 'Loading...',
        refresh: 'Refresh',
  ...
  async function load() {
    ...
    if (gradeRes.ok) {
      setFinalGrade(gradeRes.data && gradeRes.data.published ? gradeRes.data : null);
    } else {
      setFinalGrade(null);
    }
        ...
        <article className="glass-card">
          ...
          {finalGrade ? (
            <div className="student-notif-list" style={{ marginTop: 10 }}>
              <div className="student-notif-item">
                ...
                <div className="student-notif-copy">
                  ...
                  <p>
                    {copy.published}
                    {finalGrade.published_at ? ` - ${fmtDate(finalGrade.published_at)}` : ''}
                  </p>
                </div>
              </div>
            </div>
        ...
        <article className="glass-card">
          ...
          <div className="student-notif-list" style={{ marginTop: 10 }}>
            {gradeAlerts.map((n, idx) => (
              <button key={n.delivery_id || idx} className="student-notif-item" type="button" onClick={onOpenNotifications}>
